...
public class Constants {
	...
	public static final String HOSTNAME = "Hostname is: ";
	public static final String PORTNAME = "Port number is: ";
	public static final String SERVER_LISTENING = "Server started.\nListening for connections on port : ";
	...
	public static final String ERROR_CLIENT = "Please first start the server before starting the client";
	public static final String ERROR_INVALID_NUMBER = "Line in the input file is not an integer";
	public static final String ERROR_CLOSING_SOCKET = "Error closing server socket!\n";
	public static final String ERROR_CONNECTING_SERVER = "Error connecting to the server! Please try again!\n" ;
	public static final String ERROR_UNKNOWN_HOST = "Unknown Host Exception: \n ";
