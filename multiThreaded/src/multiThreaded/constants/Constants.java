...
public class Constants {
	...
	public static final String AVG_NUM_CHARS_PER_SENTENCE = "AVG_NUM_CHARS_PER_SENTENCE";
	public static final String MAX_FREQ_WORD = "MAX_FREQ_WORD";
	public static final String LONGEST_WORD = "LONGEST_WORD";
	...
	public static final String ERROR_INVALID_CHAR = "Invalid character in file";
	...
	public static final String ERROR_ALL_ARG_FILES_REQUIRED = "provide all 3 files: input.txt , output.txt and metrics.txt";
